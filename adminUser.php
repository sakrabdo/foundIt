...
<script>
	$(document).ready(function(){
        ...
        $('#adminsearch_user').click(function() {
            var input_su = $('#admininput_su').val();
    ...
    <section class="admin_section" style="background: url(images/admin_bg.svg)">
        <div class="safearea">
            ...
            <div class="admin_sectionCont">
                ...
                <form action="">
                    <input type="text" placeholder="Search Users By Name..." id="admininput_su" class="admin_searchIpt">
                    <div id="adminsearch_user" class="admin_searchBtn transition">Search</div>
                </form>

                <div class="hp_itemsCont" id="adminUser">
