...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url: 'ajax_get_mylostdata.php',
			success: function(data){
				$("#my_lostdata").html(data);
			}
		});

        $.ajax({
			url: 'ajax_get_myfounddata.php',
			success: function(data){
				$("#my_founddata").html(data);
			}
		});
...
<div class="wrapper">
    ...
    <section style="background: url(images/gradientBlue_bg.png)">
        <div class="safearea">
            ...
            <div class="hp_cont">
                <div class="hp_title">MY LOST ITEMS</div>

                <div style="margin-bottom:50px" class="hp_itemsCont" id="my_lostdata">

                </div>

                <div class="hp_title">MY FOUND ITEMS</div>

                <div class="hp_itemsCont" id="my_founddata">
