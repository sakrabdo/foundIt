...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url: 'ajax_admin_found.php',
			success: function(data){
				$("#adminFound").html(data);
			}
		});
        


        $('#adminsearch_found').click(function() {
            var input_sf = $('#admininput_sf').val();
		...
		<div class="safearea">
            ...
            <div class="foundit_header">
                ...
                <div class="admin_nav">
                    ...
                    <a href="adminFound.php" class="admin_navLink hvr-underline-from-center navActive">Found Items</a>
    ...
    <section class="admin_section" style="background: url(images/admin_bg.svg)">
        <div class="safearea">
            ...
            <div class="admin_sectionCont">
                ...
                <form action="">
                    <input type="text" placeholder="Search Found Items..." id="admininput_sf" class="admin_searchIpt">
                    <div id="adminsearch_found" class="admin_searchBtn transition">Search</div>
                </form>

                <div class="hp_itemsCont" id="adminFound">
