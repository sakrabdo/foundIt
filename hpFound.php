...
<script>
	$(document).ready(function(){
		...
		$.ajax({
			url: 'ajax_get_found.php',
			success: function(data){
				$("#found_data").html(data);
			}
		});
        


        $('#search_found').click(function() {
            var input_sf = $('#input_sf').val();
...
<div class="wrapper">
    ...
    <header>
		<div class="safearea">
            ...
            <div class="foundit_header">
                <a href="hpFound.php" class="foundit_logo"></a>

                <div class="foundit_header_mid center_left">
                    <form action="">
                        <input type="text" id="input_sf" class="fi_header_search" placeholder="Search For Found Items...">
                        
                        <div class="header_searchBtn transition" id="search_found">Search Found</div>
                    </form> 
                    <nav>
    ...
    <section style="background: url(images/gradientBlue_bg.png)">
        <div class="safearea">
            ...
            <div class="hp_cont">
                <div class="hp_title">FOUND ITEMS</div>

                <div class="hp_itemsCont" id="found_data">
