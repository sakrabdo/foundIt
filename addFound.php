    ...
    <section style="background: url(images/gradientBlue_bg.png)">
        <div class="safearea">
            ...
            <div class="addItem_cont">   
                <div class="addItem_title">Add Your Found Item</div>

                <form action="insertFound.php" method="POST" accept-charset="utf-8" class="addItem_form" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="In Which City Did You Find It?" name="add_city" required>
                    ...
                    <span style="color:red; font-weight:600; background-color:white; fontsize 16px; margin-bottom:30px; padding:5px; border-radius:10px">
                        <?php
                         if(isset($_GET['insertF_error'])){ 
                            $e=$_GET['insertF_error'];
                            echo $e; }
                         else if(isset($_GET['insertF_success'])){
                            $s=$_GET['insertF_success'];
